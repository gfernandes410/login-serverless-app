...
describe('Logs Mappers', () => {
    ...
    describe('lambdaEventToLogEvent', () => {
        ...
        it('Create a new log', () => {
            ...
            const logObg = LogsMapper.lambdaEventToLogEvent(LAMBDA_LOG_EVENT.AUTH, event)

             const response = {
                title: '(lambda auth) Evento HTTP recebido',
                payload: {
                    resource: '/app',
                    endpoint: '/app',
                    headers: {
                    ...
                    queryString: {},
                    body:
                    '{"key":"523ec55c02b999aa0fd7208d8f5497e1715f207e",   "secret":"1e6c213cd22c7d20b9752f57e5d4681d"}',
                    requestContext: {
                        "stage": 'dev' 
                    }
                },
            ...
            expect(logObg).toBeDefined()
            expect(logObg).toMatchObject(response)
        })
